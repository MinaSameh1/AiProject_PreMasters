...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--early_stopping', help='Early stopping epochs.', type=int, default=2)
    parser.add_argument('--dump', help='Dump output of NN to CSV file(s).', action='store_true')
    parser.add_argument("--max_epochs", help='maximum epochs', type=int, default=10)
...
def main():
    ...
    if args.mode == 'train':
        ...
        train(model, loader, line_mode=args.line_mode, early_stopping=args.early_stopping, max_epochs=args.max_epochs)
